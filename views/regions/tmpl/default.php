...
HTMLHelper::_('script', 'media/com_synchronization/js/regions.min.js', array('version' => 'auto'));
...
<form action="<?php echo Route::_('index.php?option=com_synchronization&view=regions'); ?>" method="post"
