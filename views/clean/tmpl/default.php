...
HTMLHelper::_('script', 'media/com_synchronization/js/clean.min.js', array('version' => 'auto'));
...
<form action="<?php echo Route::_('index.php?option=com_synchronization&view=clean'); ?>" method="post"
	...
	<div id="j-main-container" class="span10">
		...
		<h2><?php echo Text::_('COM_SYNCHRONIZATION_CLEAN_TASKS'); ?></h2>
		<ul data-clean-tasks>

			<li data-task="deleteExtensions">
				<strong><?php echo Text::_('COM_SYNCHRONIZATION_CLEAN_TASKS_DELETE_EXTENSIONS'); ?></strong>
			...
			<li data-task="deleteDB">
				<strong><?php echo Text::_('COM_SYNCHRONIZATION_CLEAN_TASKS_DELETE_DB'); ?></strong>
				<i class="icon-loop loading" style="display: none;"></i>
				<i class="icon-cancel-2 error text-error" style="display: none;"></i>
				<i class="icon-ok success text-success" style="display: none;"></i>
			</li>

			<li data-task="deleteFolders">
				<strong><?php echo Text::_('COM_SYNCHRONIZATION_CLEAN_TASKS_DELETE_FOLDERS'); ?></strong>
				<i class="icon-loop loading" style="display: none;"></i>
				<i class="icon-cancel-2 error text-error" style="display: none;"></i>
				<i class="icon-ok success text-success" style="display: none;"></i>
			</li>
