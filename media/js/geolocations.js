...
(function ($) {
	$(document).ready(function () {
		$('[onclick*="geolocations.parse"]').attr('id', 'geolocationsParse').removeAttr('onclick');

		$('#geolocationsParse').on('click', function () {
			parseGeolocationsItems();
		});
	});

	function parseGeolocationsItems() {
		var results = $('#results'),
		...
		ajaxData['task'] = 'geolocations.parse';
		ajaxData['first'] = 'true';
